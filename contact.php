...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            ...
            <form action="controllers/save.php" method="POST">
               <div class="contact_section_2">
                  ...
                  <input type="submit" class="send_bt" value="Send" name="save_contact">
               </div>
            </form>
            </div>
         </div>
      ...
      <div class="contact_section layout_padding mb-3">
         <div class="container">
         <h1 class="contact_taital">Contact List</h1>
         <div class="contact_section_2">
         <div class="mail_section_1">
            <table class="table table-bordered">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="d-flex">
                        <a href="controllers/edit.php?id=<?php echo $row['id']?>" class="btn btn-secondary m-3" ><span class="material-symbols-outlined">edit</span></i></a>
                        <a href="controllers/delete.php?id=<?php echo $row['id']?>" class="btn btn-danger m-3"><span class="material-symbols-outlined">delete</span></a>
                     </td>
                  </tr>
                  <?php }?>
               </tbody>
