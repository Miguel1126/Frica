...
if(isset($_POST['update_product'])){
   ...
   $price = $_POST['price'];
    ...
    $query = "UPDATE products set product = '$product', brand = '$brand', price = '$price' WHERE id = $id";
...
<html lang="en">
   ...
   <body>
    ...
    <div class="contact_section layout_padding mb-3">
         <div class="container">
            <h1 class="contact_taital">Editing Product</h1>
            <form action="../controllers/editProd.php?id=<?php echo $_GET['id']; ?>" method="POST">
               <div class="contact_section_2">
                  <div class="mail_section_1">
                  <input type="text" class="mail_text" placeholder="Product" name="product" value="<?php echo $product; ?>">
                  <input type="text" class="mail_text" placeholder="Brand" name="brand" value="<?php echo $brand; ?>">
                  <input type="text" class="mail_text" placeholder="Price" name="price" value="<?php echo $price; ?>">
                  <input type="submit" class="send_bt" value="Update" name="update_product">
               </div>
            </form>
            </div>
         </div>
